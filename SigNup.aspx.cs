...
public partial class SigNup : System.Web.UI.Page
{
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["DatabaseConnectionString1"].ConnectionString);
            conn.Open();
            string insertQuery = "insert into UsersigNup(Uid,Userid,Password,Name,PhoneNo,Email,Address,Gender,Date_of_Birth) values(@Uid,@Username,@password,@name,@Contact_number,@email,@address,@Gender,@Date_of_Birth )";
