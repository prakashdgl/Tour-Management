<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="gold.aspx.cs" Inherits="gold" %>
...
<nav>
    <ul class="cf">
        ...
        <li><a class="dropdown" href="#">LOCATIONSa>
            <ul>
...
<div id="content">
    <h2 style="background-color:grey;">Gold Packages:</h2><asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
    ...
    <p style="float:right;font-size:small; color:red;">* Mode of transport from your city to destination:a/c3-Tier Train(Train charges Applicable) </p><br />
    &nbsp;<br />
    <br />
    <img src="Images/gda.jpg" height="200px" width="265px" style="padding-left:2%; padding-top:0%;" />
    <img src="Images/gdi.jpg" height="200px" width="265px" style="padding-left:15%;" />
    <<img src="Images/gdo.jpg" height="200px" width="265px" style="padding-top:15%;padding-left:2%;" />
    <img src="Images/gkol.jpg" height="200px" width="265px" style="padding-left:15%;" />
</div>
