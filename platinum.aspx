<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="platinum.aspx.cs" Inherits="platinum" %>
...
<div id="content">
    <h2 style="color:blue">Platinum Packages:</h2>
    ...
    <p style="float:right;font-size:small; color:red;">* Mode of transport from your city to destination:Ecnomy class Flight(Flight charges Applicable) </p><br />
    &nbsp;<br />
    <br />
    <img src="Images/pda.jpg" height="200px" width="265px" style="padding-left:2%; padding-top:0%;" />
    <img src="Images/pdi.jpg" height="200px" width="265px" style="padding-left:15%;" />
    <<img src="Images/pdo.jpg" height="200px" width="265px" style="padding-top:15%;padding-left:2%;" />
    <img src="Images/pkol.jpg" height="200px" width="265px" style="padding-left:15%;" />
</div>
<div id="comment">
    <nav2>
    <ul>
